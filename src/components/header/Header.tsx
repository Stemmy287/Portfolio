    ...
    <header className={s.headerAndNavContainer}>
      <div className={s.header}>
        ...
        <div className={s.buttonMenu}>
          <svg onClick={() => onClickMenuHandler(true)} width="30px" height="30px" viewBox="0 0 12 12">
            <g>
      ...
      <div className={isActiveNav ? `${s.nav} ${s.show}` : s.nav} tabIndex={1}
        ...
        <div className={s.closeButton}>
          <svg onClick={() => onClickMenuHandler(false)}
               width="37px" height="37px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={s.myAccounts}>
          <a href="https://github.com/Stemmy287" target={'_blank'}>
            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" id="Shopicons"
                 xmlns="http://www.w3.org/2000/svg" x="0" y="0" xmlSpace="preserve">
          ...
          <a href="https://www.codewars.com/users/EvgenLipa" target={'_blank'}>
            <svg fill="#000000" width="27px" height="27px" viewBox="0 0 24 24" role="img"
          ...
          <a href="https://t.me/steem287" target={'_blank'}>
            <svg fill="#000000" width="30px" height="30px" viewBox="0 0 32 32" version="1.1"
                 xmlns="http://www.w3.org/2000/svg">
              <path
